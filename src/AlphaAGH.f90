...
module GlobalAGH
    ...
    integer :: nTrait,nSnp,nAnisG,nAnisP,nAnisRawPedigree,AllFreqSelCycle,nAnisH
    ...
    integer,allocatable :: seqid(:),seqsire(:),seqdam(:),RecodeGenotypeId(:),passedorder(:),RecPed(:,:),GinA(:),AinG(:)!,RecodeIdGeno(:)
